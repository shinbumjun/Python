...
print('ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ')
print('모델 학습 및 검정 : k-fold 적용 - 비교적 가용 데이터가 적은 경우에 효과적')
k = 4
val_samples = len(x_train) // k # 정수 나누기
all_mse_history = []
...
from sklearn.metrics import r2_score
print('설명력 : ', r2_score(y_test, model2.predict(x_test)))  # 0.7397
