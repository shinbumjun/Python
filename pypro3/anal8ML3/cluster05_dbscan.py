...
print(x[:10])
print('실제 군집 id : ', y[:10]) # [0 0 0 1 1 1 0 0 0 1]
...
print('예측군집 id : ', pred1[:10]) # [0 0 0 0 1 1 0 1 0 1]
...
print('ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ')
print('KMeans로 원하는 군집을 얻지 못한 경우 DBSCAN을 수행한다.')
dm = DBSCAN(eps=0.2, min_samples = 5, metric = 'euclidean')
pred2 = dm.fit_predict(x)
print('예측군집 id : ', pred2[:10]) # [0 0 0 1 1 1 0 0 0 1]
