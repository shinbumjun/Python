...
# print('ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ')
# print(x[pred == 0]) # 150개가 나누어져서 cluster
# print('ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ')
# print(x[pred == 1])
# print('ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ')
# print(x[pred == 2])
...
print('ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ')
print('k값? 방법1) 엘보우(elbow) 기법 - 클러스터 간 SSE의 차이를 이용해 최적의 클러스터 수를 제시')
...
elbow_func(x) # 경사가 완만해지는 곳 -> 3

print('ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ')
print('k값? 방법2) 실루엣(silhoutte) 기법 - 클러스터의 품질을 정량적으로 계산해 표현')
