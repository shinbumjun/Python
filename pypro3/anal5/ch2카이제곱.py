...
print('ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ 1. 적합도 검증 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ')
data = [4, 6, 17, 16, 8, 9] # 관측값
# data = [11, 5, 10, 13, 10, 11] # 관측값
print(stats.chisquare(data))
# Power_divergenceResult(statistic=14.200000000000001, pvalue=0.014387678176921308)

print('ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ 2. 적합도 검증 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ')
result = stats.chisquare(data)
print('검정통계량 X2 값:%.5f, p-value:%f'%(result))
print(result.statistic, result.pvalue)
# 검정통계량 X² 값:14.20000, p-value:0.014388
# 14.200000000000001 0.014387678176921308

print('ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ 3. 적합도 검증 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ')
...
print('ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ 결과 얻기 2 - 카이제곱 분포표 사용 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ')
print('검정통계량 X²값:14.20000, df: (6 - 1) 5, 임계값:11.07 이므로 귀무가설을 기각하고 대립가설을 채택한다')

print('ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ')
print('ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ <선호도 분석 실습> ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ')
