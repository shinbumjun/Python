...
import numpy as np
print('ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ 1) step1 : array 관련 문제 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ')
...
'''
1행 합계: 1.1675228609366524
1행 최대값: 1.576529833690484
2행 합계: 1.100493808361086
2행 최대값: 2.264509403889521
3행 합계: -1.2407975953170283
3행 최대값: 1.8435379817234865
4행 합계: 0.4485650314243174
4행 최대값: 0.3219633659255565
5행 합계: 0.46595660519413273
5행 최대값: 0.7508790258275592
'''

print('ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ 2) step2 : indexing 관련문제 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ')
...
print('ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ 3) step3 : unifunc 관련문제 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ')
